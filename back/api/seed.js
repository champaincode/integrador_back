...
Producto.bulkCreate([
    {
        ...
        price: 10,
        stock: 4,
        image:"https://djftrby1k8irl.cloudfront.net/s3fs-public/2022-03%2FSkinny%20Vainilla%20Latte%20425x425%20sin%20fondo.png?auto=format,compress&q=70&crop=focalpoint&ar=1:1.0&w=180&fit=crop"
      },
      {
        ...
        price: 15,
        stock: 6,
        image:"https://djftrby1k8irl.cloudfront.net/s3fs-public/2022-03%2FLatte%20Macchiato%20425x425%20sin%20fondo.png?auto=format,compress&q=70&crop=focalpoint&ar=1:1.0&w=180&fit=crop"
      },
      {
        tittle: "cappuccino",
        drink: true,
  ...
  .then(() => console.log('Datos de productos sembrados'))
